...
export function registerIpcHandlers(mainWindow: BrowserWindow) {
  ...
  ipcMain.handle("deck:move-item-to-group", (_e, deckId: string, pageId: string, itemId: string, groupId: string, absCol?: number, absRow?: number) => { console.log("MOVE-TO-GROUP", { itemId, groupId, absCol, absRow }); const r = deckStore.moveItemToGroup(deckId, pageId, itemId, groupId, absCol, absRow); console.log("MOVE-TO-GROUP result:", r); webServer.broadcastDeckUpdate(deckStore.getDecks()); return r; });
