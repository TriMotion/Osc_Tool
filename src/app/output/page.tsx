      ...
      <div className="flex items-end gap-3">
        <div>
          ...
          <input
            ...
            className="bg-elevated border border-white/10 rounded-lg px-3 py-2 text-sm w-40 focus:outline-none focus:border-output/18"
          />
        </div>
        <div>
          ...
          <input
            ...
            className="bg-elevated border border-white/10 rounded-lg px-3 py-2 text-sm w-24 focus:outline-none focus:border-output/18"
          />
        </div>
      </div>
      <EndpointPicker
                ...
                {effects.map((eff) => (
                  <div key={eff.id} className="flex items-center justify-between bg-elevated rounded-lg px-4 py-2.5 border border-white/5">
                    <div className="min-w-0">
                      <div className="text-sm text-white font-medium truncate" title={eff.name}>{eff.name}</div>
